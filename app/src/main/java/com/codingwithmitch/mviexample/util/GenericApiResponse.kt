...
sealed class GenericApiResponse<T> {
    ...
    companion object {
        ...
        }  // In case of error in the CallAdapter, it passes this Throwable parameter and creates ApiErrorResponse.

        // In case error occured after response retrieved, it creates ApiErrorResponse in the logic below.
